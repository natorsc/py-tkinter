...
class App(tk.Frame):
    def __init__(self, **kwargs):
        ...
        string_var = tk.StringVar(value='press Enter (Return).')
        entry = tk.Entry(master=self, textvariable=string_var)
        entry.bind('<Return>', lambda event: print(string_var.get()))
        entry.pack(fill=tk.X, expand=tk.TRUE)
